...
// import 'package:sajilo_hariyo/features/home/presentation/view/ar_product_view.dart';

// class AdminProductDetailView extends StatefulWidget {
//   final ProductEntity product;
//   const AdminProductDetailView({super.key, required this.product});
...
//              // Pop if we just deleted, but be careful of duplicates?
//              // Usually parent view handles refresh, we just pop.
//            }
//         },
//         child: Stack(
//           children: [
...
//                           style: GoogleFonts.poppins(
//                             color: widget.product.stock > 0 ? primaryGreen : Colors.red,
...
//           TextButton(
//             onPressed: () {
//                context.read<AdminProductBloc>().add(DeleteProductEvent(widget.product.id!));
...
//                       context,
//                       MaterialPageRoute(
//                         builder: (_) => AddProductView(product: widget.product), // Passing product to edit
//                       ),
//                     );
//                   },
//                   style: ElevatedButton.styleFrom(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    Icon(LucideIcons.tag, size: 18, color: primaryGreen),
                                    ...
                                    Expanded(
                                      child: RichText(
                                        text: TextSpan(
                                          children: [
                                            TextSpan(
                                              text: widget.product.categoryName ?? "Plant",
                                              style: GoogleFonts.poppins(
                                                color: darkText,
                                                fontSize: 14,
                                                fontWeight: FontWeight.w600,
                        ...
                        Row(
                          children: [
                            Icon(LucideIcons.heart, size: 20, color: primaryGreen),
                            const SizedBox(width: 8),
                            Text(
                              "Care Profile",
                              style: GoogleFonts.poppins(
                        ...
                        if ((widget.product.height != null && widget.product.height!.isNotEmpty) || 
                          ...
                          Row(
                            children: [
                              Icon(LucideIcons.ruler, size: 20, color: primaryGreen),
                              const SizedBox(width: 8),
                              Text(
                                "Details",
                                style: GoogleFonts.poppins(
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                if (widget.product.potSize != null && widget.product.potSize!.isNotEmpty)
                                  Expanded(
                                    child: _buildDetailItem(
                                      LucideIcons.flower2,
                                      "Pot Size",
                        ...
                        Row(
                          children: [
                            Icon(LucideIcons.info, size: 20, color: primaryGreen),
                            const SizedBox(width: 8),
                            Text(
                              "About Plant",
                              style: GoogleFonts.poppins(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => AddProductView(product: widget.product),
                      ),
                    );
                  },
                  style: ElevatedButton.styleFrom(
